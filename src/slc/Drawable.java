...
public class Drawable extends ImageView {
    ...
    public static final String[] TEXTURES = {"block","stone","grass","water","plank","plank_on_water","cobweb","plum","fence_full","door","door_open",
			 "room","shade","block_corner","block_top","block_sides","block_end","black","fence_left","fence_right","fence_no_conn","line_corner","line_top",
			 "line_sides","line_end","fasada"};
   ...
   public static final int[]    SOLID_IDs  	= {TEXTURE_BLOCK, TEXTURE_WATER, TEXTURE_PLUM, TEXTURE_FENCE_FULL, TEXTURE_DOOR,
   											   TEXTURE_BLOCK_CORNER, TEXTURE_BLOCK_TOP, TEXTURE_BLOCK_SIDES, TEXTURE_BLOCK_END,
    ...
    public Drawable(int textureid, int group, int layer, boolean solid, int angle, int scalex, int scaley, int hue, int saturation, int brightness){
        super(AssetsManager.getImage(textureid));
	...
	public void init(int textureid, int group, int layer, boolean solid, int angle, int scalex, int scaley, int hue, int saturation, int brightness){
