...
public class Drawable extends ImageView {
    ...
    public static final String[] TEXTURES = { "block", "stone", "grass", "water", "plank", "plank_on_water", "cobweb",
            "plum", "fence_full", "door", "door_open",
            "room", "shade", "block_corner", "block_top", "block_sides", "block_end", "black", "fence_left",
            "fence_right", "fence_no_conn", "line_corner", "line_top",
    ...
    public Drawable(int textureid, int group, int layer, boolean solid, int angle, int scalex, int scaley, int hue,
